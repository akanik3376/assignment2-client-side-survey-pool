...
const FAQ = () => {
    return (
        <div className='my-16 bg-[#F3F3F3] p-4 md:p-10'>
            <div >
                <h2 className="text-5xl font-semibold text-center m-4 mt-8  border-b-2 border-dark-03 p-2 w-40 mx-auto text-rose-500">
                    FAQ
                </h2>
